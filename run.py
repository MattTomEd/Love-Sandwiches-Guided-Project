...
def validate_data(values):
    ...
    Will raise Value Error if strings cannot be converted into int,
...
def calculate_stock_data(data):
    """
    Calculate the average stock for each item type, adding 10% as per 
    company requirement
    """
...
print(f"Welcome to Love Sandwiches Data Automation\n_______________________")
main()